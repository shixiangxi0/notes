...
## Background: The Von Neumann Architecture and Object-Oriented Programming
...
> The "dual" in Dual World Theory is relative to the system in view. Different system boundaries, observational scales, and interpretive capacities redraw the line between the field of unresolved change and the domain of internal causal history.
...
Dual World is best understood as a layered structure that forms as a system keeps absorbing change while preserving the continuity of its own history.
