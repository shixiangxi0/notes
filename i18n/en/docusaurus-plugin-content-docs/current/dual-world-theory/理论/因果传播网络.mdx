...
Convergence is the most important; the others exist mainly to guarantee it. It is the fundamental assurance that the world can run stably. See [Eventual Causal Consistency](/docs/dual-world-theory/theory#eventual-causal-consistency).
